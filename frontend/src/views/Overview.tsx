      ...
      <svg viewBox="0 0 120 40" className="w-full h-full" preserveAspectRatio="none">
        <defs>
          <linearGradient id={`spark-${positive}`} x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor={positive ? '#29D6C7' : '#E85D5D'} stopOpacity="0.3" />
            <stop offset="100%" stopColor={positive ? '#29D6C7' : '#E85D5D'} stopOpacity="0" />
          </linearGradient>
        </defs>
        <path
          d={positive
              ...
              <svg viewBox="0 0 600 200" className="w-full h-full" preserveAspectRatio="none">
                <defs>
                  <linearGradient id="perf-grad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#53E0D4" stopOpacity="0.4" />
                    <stop offset="100%" stopColor="#53E0D4" stopOpacity="0" />
                  </linearGradient>
                </defs>
                ...
                <path d="M0,180 C50,170 100,140 150,150 C200,120 250,80 300,90 C350,50 400,60 450,30 C500,20 550,10 600,5" fill="none" stroke="#53E0D4" strokeWidth="2" />
