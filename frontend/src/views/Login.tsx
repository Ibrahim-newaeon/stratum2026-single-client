        ...
        <section className="w-full lg:w-3/5 flex flex-col items-center justify-center p-6 lg:p-12 relative overflow-hidden">
          ...
          <div className="w-full max-w-[420px] relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-[14.5px] text-[#A9A6BD] mt-2">
            ...
            {mfaRequired ? (
              <form onSubmit={handleMfaSubmit} className="space-y-5">
                <div>
                  ...
                  <p className="text-[13px] text-[#A9A6BD] mt-1">
                    Enter the 6-digit code from your authenticator app, or a backup code.
                  </p>
                </div>
                {error && (
                  <div className="flex items-start gap-2 p-3 rounded-[12px] text-sm bg-[rgba(255,111,89,0.08)] border border-red-500/30 text-red-300">
                    <AlertCircle className="w-4 h-4 flex-shrink-0 mt-0.5" />
                    <span>{error}</span>
                  </div>
                )}
                <div>
                  <label htmlFor="mfa-code" className="block text-[13px] text-[#A9A6BD] mb-1.5">
                    Verification code
                  </label>
                  <input
                    id="mfa-code"
                    ...
                    maxLength={8}
                    placeholder="123456"
                    className="w-full h-12 px-4 rounded-[12px] bg-[#1A1821] border border-[#282531] text-white text-center tracking-[0.4em] text-lg placeholder:text-[#5A5A5A] focus:border-[#29D6C7] focus:outline-none transition-colors"
                  />
                </div>
                <button
                  type="submit"
                ...
                <button
                  type="button"
                  onClick={cancelMfa}
                  className="w-full text-[13px] text-[#A9A6BD] hover:text-white transition-colors"
                >
                  Back to sign in
                </button>
              </form>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              {showVerificationBanner && (
                <div className="flex items-start gap-2 p-3 rounded-[12px] text-sm bg-[rgba(255,90,31,0.06)] border border-[#29D6C7]/30 text-[#FFB89A]">
                  ...
                  <div>
                    ...
                    <Link
                      to="/verify-email"
                      className="block mt-1 text-[#29D6C7] font-medium hover:text-[#53E0D4] transition-colors text-xs"
                    >
              ...
              {/* Lockout */}
              {isLockedOut && (
                <div className="flex items-center gap-3 p-4 rounded-[12px] text-sm bg-[rgba(255,90,31,0.06)] border border-[#29D6C7]/30 text-[#FFB89A]">
              ...
              <div className="space-y-2">
                <label
                  htmlFor="login-email"
                  className="text-[11px] uppercase tracking-[0.12em] text-[#7B7791] ml-1"
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-12 bg-[rgba(255,255,255,0.015)] border border-[#282531] rounded-[12px] pl-11 pr-4 text-sm text-white placeholder-[#7B7791] outline-none focus:ring-4 focus:ring-[#29D6C7]/[0.12] focus:border-[#29D6C7]/50 transition-colors"
                  />
                </div>
                {emailError && (
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center ml-1">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-xs text-[#29D6C7] hover:text-[#53E0D4] transition-colors font-medium"
                  >
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-12 bg-[rgba(255,255,255,0.015)] border border-[#282531] rounded-[12px] pl-11 pr-11 text-sm text-white placeholder-[#7B7791] outline-none focus:ring-4 focus:ring-[#29D6C7]/[0.12] focus:border-[#29D6C7]/50 transition-colors"
                  />
                  <button
                    type="button"
              ...
              <label className="flex items-center gap-2.5 select-none cursor-pointer pt-1">
                <input
                  ...
                  className="w-4 h-4 rounded border border-[#282531] bg-[#1A1821] accent-[#29D6C7] cursor-pointer"
                />
                <span className="text-[13px] text-[#A9A6BD]">Keep session active for 24h</span>
              </label>
