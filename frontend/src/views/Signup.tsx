...
const inputClass =
  'w-full h-12 bg-[rgba(255,255,255,0.015)] border border-[#282531] rounded-[12px] pl-11 pr-4 text-sm text-white placeholder-[#7B7791] outline-none focus:ring-4 focus:ring-[#29D6C7]/[0.12] focus:border-[#29D6C7]/50 transition-colors';

const labelClass = 'text-[11px] uppercase tracking-[0.12em] text-[#7B7791] ml-1';
...
function Pill({ children }: { children: React.ReactNode }) {
  return (
    <span
      ...
      style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid #282531' }}
    >
      <span
...
function PrimaryButton({ children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) {
  return (
    <button
      {...props}
      className="w-full h-12 rounded-full bg-[#29D6C7] text-white font-medium text-[14px] flex items-center justify-center gap-2 transition-all hover:bg-[#1FB8AB] hover:-translate-y-px disabled:opacity-50 disabled:hover:translate-y-0 disabled:cursor-not-allowed"
...
function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex bg-[#0D0C13] text-white" style={{ fontFamily: FONT_STACK }}>
      <AuthLeftPanel />
    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-[440px] relative z-10">
          <div className="mb-8">
            <div className="w-12 h-12 rounded-[12px] bg-[rgba(255,90,31,0.08)] border border-[#29D6C7]/30 flex items-center justify-center mb-6">
              <Lock className="w-5 h-5 text-[#29D6C7]" />
            </div>
            <h2 className="text-[28px] leading-[1.1] tracking-tight font-medium">
              Verify your identity
            </h2>
            <p className="text-[14.5px] text-[#A9A6BD] mt-2">Choose how you'd like to verify.</p>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-[14px] bg-[#1A1821] border border-[#282531] hover:border-[#29D6C7]/40 transition-colors group disabled:opacity-50"
            >
              <div className="w-11 h-11 rounded-[10px] bg-[rgba(255,90,31,0.08)] border border-[#29D6C7]/30 flex items-center justify-center flex-shrink-0">
                <Mail className="w-5 h-5 text-[#29D6C7]" />
              </div>
              <div className="text-left flex-1">
                <div className="text-sm font-medium text-white group-hover:text-[#29D6C7] transition-colors">
                  Verify via Email
                </div>
                <div className="text-xs text-[#7B7791] mt-0.5">Send code to {formData?.email}</div>
              </div>
            ...
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-[14px] bg-[#1A1821] border border-[#282531] hover:border-emerald-500/40 transition-colors group disabled:opacity-30 disabled:cursor-not-allowed"
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-xs text-[#7B7791] mt-0.5">
          ...
          <div className="flex justify-center mt-8">
            <button
              ...
              className="text-xs text-[#A9A6BD] hover:text-white transition-colors font-medium"
            >
      ...
      <AuthLayout>
        <div className="w-full max-w-[440px] relative z-10">
          <div className="mb-8">
            ...
            <p className="text-[14.5px] text-[#A9A6BD] mt-2 mb-1">We've sent a 6-digit code to</p>
            <p className="text-[#29D6C7] text-sm font-medium">{formData?.email}</p>
          </div>
          ...
          <div className="mb-6">
            <input
              ...
              className="w-full text-center text-2xl tracking-[0.5em] h-14 rounded-[12px] bg-[rgba(255,255,255,0.015)] border border-[#282531] text-white placeholder-[#7B7791] focus:ring-4 focus:ring-[#29D6C7]/[0.12] focus:border-[#29D6C7]/50 transition-colors outline-none"
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="text-xs text-[#29D6C7] hover:text-[#53E0D4] transition-colors disabled:opacity-40 disabled:hover:text-[#29D6C7] font-medium"
              >
      ...
      <AuthLayout>
        <div className="w-full max-w-[440px] relative z-10">
          <div className="mb-8">
            ...
            <p className="text-[14.5px] text-[#A9A6BD] mt-2 mb-1">
    ...
    return (
      <AuthLayout>
        <div className="w-full max-w-[440px] relative z-10 text-center">
          <div className="w-16 h-16 rounded-full bg-[rgba(255,90,31,0.08)] border border-[#29D6C7]/30 flex items-center justify-center mx-auto mb-6">
            <Lock className="w-8 h-8 text-[#29D6C7]" />
          </div>
          <h2 className="text-[28px] leading-[1.1] tracking-tight font-medium">
            Signup is invite-only
          </h2>
          <p className="text-[14.5px] text-[#A9A6BD] mt-3 mb-6">
            {getApiErrorMessage(
          ...
          <Link
            to="/login"
            className="inline-flex items-center justify-center gap-2 w-full h-12 rounded-full bg-[#29D6C7] text-white text-sm font-medium hover:bg-[#53E0D4] transition-colors"
          >
            Log in
            <ArrowRight className="w-4 h-4" />
          </Link>
      ...
      <AuthLayout>
        <div className="w-full max-w-[440px] relative z-10 text-center">
          ...
          <p className="text-[14.5px] text-[#A9A6BD] mt-3 mb-6">
            ...
            <span className="text-[#29D6C7] font-medium">14-day Starter trial</span> is now active.
          </p>

          <div className="rounded-[14px] border border-[#282531] bg-[#1A1821] p-5 mb-6 text-left">
            <p
              className="text-[11px] text-[#29D6C7] font-medium uppercase tracking-[0.12em] mb-2"
              style={{ fontFamily: MONO_STACK }}
            >
              Starter Trial · 14 days
            </p>
            <p className="text-[13px] text-[#A9A6BD] leading-relaxed">
            ...
            <button
              ...
              className="mt-4 text-xs text-[#29D6C7] hover:text-[#53E0D4] transition-colors font-medium"
            >
              View plans →
            </button>
          </div>
        ...
        <section className="w-full lg:w-3/5 flex flex-col items-center justify-center p-6 lg:p-12 relative overflow-hidden">
          ...
          <div className="w-full max-w-[440px] relative z-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-[14.5px] text-[#A9A6BD] mt-2">Provision your secure workspace.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#7B7791] pointer-events-none" />
                  <input
                    {...register('name')}
                    id="signup-name"
                    type="text"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#7B7791] pointer-events-none" />
                  <input
                    {...register('email')}
                    id="signup-email"
                    type="email"
              ...
              <div className="space-y-2">
                <label
                  ...
                  style={{ fontFamily: MONO_STACK }}
                >
                  Phone <span className="normal-case text-[#7B7791]">(optional)</span>
                </label>
                <div className="relative">
                  <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#7B7791] pointer-events-none" />
                  <input
                    {...register('phone')}
                    id="signup-phone"
                    type="tel"
                ...
                <p className="text-xs text-[#7B7791] ml-1">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-[18px] h-[18px] text-[#7B7791] pointer-events-none" />
                  <input
                    {...register('password')}
                    id="signup-password"
                  ...
                  <button
                    type="button"
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-[#7B7791] hover:text-white transition-colors"
              ...
              <label className="flex items-start gap-2.5 select-none cursor-pointer pt-1">
                <input
                  ...
                  type="checkbox"
                  id="terms"
                  className="mt-0.5 w-4 h-4 rounded border border-[#282531] bg-[#1A1821] accent-[#29D6C7] cursor-pointer flex-shrink-0"
                />
                <span className="text-[13px] text-[#A9A6BD] leading-relaxed">
                  I accept the{' '}
                  <a
                    href="/terms"
                    className="text-white hover:text-[#29D6C7] transition-colors font-medium"
                  >
                    Terms
                  </a>{' '}
                  and{' '}
            ...
            {/* Footer */}
            <div className="mt-10 pt-6 border-t border-[#282531]">
              <p className="text-[13px] text-[#A9A6BD]">
                Already have an account?
                <Link
                  to="/login"
                  className="text-white hover:text-[#29D6C7] transition-colors font-medium ml-1"
                >
                  Sign in
                </Link>
              </p>
              <div
                className="mt-6 flex items-center gap-5 text-[11px] uppercase tracking-[0.12em] text-[#7B7791]"
                style={{ fontFamily: MONO_STACK }}
              >
